  ...
  return (
    ...
    >
      <div className="bg-surface-primary/60 mx-4 w-11/12 max-w-4xl rounded-2xl border border-border-light p-8 shadow-2xl backdrop-blur-xl">
        ...
        {/* Error Message */}
        <div className="mb-4 rounded-xl border border-destructive/30 bg-destructive/10 p-4 text-sm text-text-primary">
        ...
        {(typeof errorDetails.status === 'number' ||
          ...
          <div className="mb-4 rounded-xl border border-border-warning bg-surface-warning p-4 text-sm text-text-primary">
