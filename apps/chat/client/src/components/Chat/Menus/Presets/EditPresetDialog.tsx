        ...
        <div className="flex w-full flex-col gap-2 px-1 pb-4 md:gap-4">
          ...
          <div className="flex justify-end gap-2 border-t border-border-medium pt-2 md:pt-4">
            <button
              ...
              className="rounded-md border border-border-medium bg-surface-secondary px-3 py-2 text-sm font-medium text-text-primary hover:bg-surface-hover focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 md:px-4"
            >
              {localize('com_endpoint_export')}
            </button>
            <button
              onClick={submitPreset}
              className="rounded-md bg-surface-submit px-3 py-2 text-sm font-medium text-white hover:bg-surface-submit-hover focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 md:px-4"
            >
