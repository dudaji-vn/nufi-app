...
export default function MCPConfigDialog({
  ...
  const renderStatusBadge = () => {
    ...
    if (connectionState === 'connecting') {
      return (
        <div className="flex items-center gap-2 rounded-full bg-status-info/10 px-2 py-0.5 text-xs font-medium text-status-info">
    ...
    if (connectionState === 'error') {
      return (
        <div className="flex items-center gap-2 rounded-full bg-status-error/10 px-2 py-0.5 text-xs font-medium text-status-error">
    ...
    if (connectionState === 'connected') {
      return (
        <div className="flex items-center gap-2 rounded-full bg-status-ok/10 px-2 py-0.5 text-xs font-medium text-status-ok">
