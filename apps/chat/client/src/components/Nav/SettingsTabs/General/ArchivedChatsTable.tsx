          ...
          return (
            <div className="flex items-center gap-2">
              ...
              <Link
                ...
                className="group flex items-center gap-1 truncate rounded-sm text-status-info underline decoration-1 underline-offset-2 hover:decoration-2 focus:outline-none focus:ring-2 focus:ring-ring"
                title={title}
