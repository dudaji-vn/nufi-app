    ...
    <>
      <div className="">
        ...
        <div className="border-token-border-medium bg-token-surface-primary hover:border-token-border-hover mb-4 w-full overflow-hidden rounded-lg border ring-0">
          ...
          {validationResult && validationResult.message !== 'OpenAPI spec is valid.' && (
            <div className="border-token-border-light border-t p-2 text-status-error">
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          onClick={saveAction}
          className="focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded bg-surface-submit px-4 py-2 font-semibold text-white hover:bg-surface-submit-hover focus:outline-none focus:ring-0 disabled:opacity-60"
          type="button"
        >
          {submitContext()}
        </button>
