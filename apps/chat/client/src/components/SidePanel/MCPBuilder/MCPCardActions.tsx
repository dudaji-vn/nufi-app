        ...
        {canCancel ? (
          ...
          >
            <div className="relative size-4">
              ...
              <X className="absolute inset-0 size-4 text-destructive opacity-0 group-hover:opacity-100" />
            </div>
          </TooltipAnchor>
        ) : (
    ...
    <div className="flex items-center gap-0.5">
      ...
      {serverStatus?.requiresOAuth && onRevoke && (
        <TooltipAnchor
          ...
          side="top"
          className={cn(buttonBaseClass, 'text-destructive hover:text-destructive/80')}
