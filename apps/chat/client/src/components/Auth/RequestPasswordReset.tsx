...
const ResetPasswordBodyText = () => {
  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <a
        className="inline-flex text-sm font-medium text-text-success transition-colors hover:underline"
        href={loginPage()}
      >
        ...
        if (data.link && !startupConfig?.emailEnabled) {
          ...
          setBodyText(
            <span>
              ...
              <a className="text-text-success hover:underline" href={data.link}>
    ...
    >
      <div className="space-y-2">
        <div className="relative">
          ...
          <label
            htmlFor="email"
            className="absolute -top-2 left-2 z-10 bg-surface-primary px-2 text-sm text-text-secondary transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-text-tertiary peer-focus:-top-2 peer-focus:text-sm peer-focus:text-text-success"
          >
      ...
      <div className="space-y-4">
        ...
        <a
          href={loginPage()}
          className="block text-center text-sm font-medium text-text-success transition-colors hover:underline"
        >
          {localize('com_auth_back_to_login')}
        </a>
      </div>
