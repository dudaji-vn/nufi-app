      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {!useBackup && (
          <div className="my-4 flex justify-center text-text-primary">
            ...
            />
            {errors.token && <span className="text-sm text-status-error">{errors.token.message}</span>}
          </div>
        )}
        {useBackup && (
          <div className="my-4 flex justify-center text-text-primary">
            ...
            />
            {errors.backupCode && (
              <span className="text-sm text-status-error">{errors.backupCode.message}</span>
            )}
          </div>
        )}
        ...
        <div className="mt-4 flex justify-center">
          {!useBackup ? (
            <button
              ...
              className="inline-flex p-1 text-sm font-medium text-text-success transition-colors hover:underline"
            >
