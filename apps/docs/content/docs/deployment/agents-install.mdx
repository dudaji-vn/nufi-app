---
title: Installing NUFI Agents
description: What NUFI Agents needs, how to point it at the gateway, and how to check the install actually took.
---

NUFI Agents is a Node server and a React UI on PostgreSQL. It is deployed
