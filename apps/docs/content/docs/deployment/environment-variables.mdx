...
The other half lives in NUFI Works itself, under Settings → Plugins → NUFI
Connection, where an instance admin sets the console URL. Both are needed; see
[Installing NUFI Works](/docs/deployment/agents-install#the-connect-plugin).
