...
`invite` writes one file a laptop opens to join. This path has been run against
a public coordinator with a real certificate, relay included; on the LAN you
need none of it.
